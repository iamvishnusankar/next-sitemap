...
Execute [`create-next-app`](https://github.com/vercel/next.js/tree/canary/packages/create-next-app) with Bun to bootstrap the example:

```bash
bunx create-next-app@latest --example with-next-sitemap with-next-sitemap-app
```
