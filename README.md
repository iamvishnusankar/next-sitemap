...
| robotsTxtOptions.additionalSitemapsIndex (optional) | Options to add additional sitemaps index to `robots.txt` host entry. These index do not get added to the sitemap.xml                                                                                                                                                                                                                                                                                                       | string[]                                                                                                                 |
...
Sitemap: https://example.com/my-custom-sitemap-index-1.xml
Sitemap: https://example.com/my-custom-sitemap-index-2.xml
Sitemap: https://example.com/my-custom-sitemap-index-3.xml
```
